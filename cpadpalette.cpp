...
CpadPalette::CpadPalette()
{
    ...
    koehlerDark << QColor(126,163,250) << QColor(249,162,159) << QColor(97 ,253,97 )
            ...
            << QColor(0  ,0  ,0  ) << Qt::green/*QColor(253,255,0  )*/ << QColor(253,1  ,0  )
                <<QColor(Qt::red) <<QColor(/*180 , 238, 180*/Qt::yellow).lighter(160) /*QColor(180 , 238, 180).darker(120)*/ <<  QColor(Qt::darkGreen);
    ...
    darkDark << QColor(126,163,250) << QColor(231,157,141)  << QColor(97 ,253,97 )
            ...
            << QColor(51 ,51 ,51 ) << QColor(242,240,8  ) << QColor(253,1  ,0  )
             << QColor(Qt::red) << QColor(/*180 , 238, 180*/Qt::yellow).lighter(160) << QColor(Qt::darkGreen);

    defaultGroup = koehlerDark;
    highlightForSearch = QColor(Qt::white);
}
